...
string MemberList::deleteMember() {
    ...
    memberList[nowLoginMemberIndex] = nullptr;
    nowLoginMemberIndex = -1;
    return id;
}
...
// Function : getNowLoginBuyList()
// Description : return now login member's buyItemList
// Return Value : BuyItemList pointer
// Created : 2022/6/2 03:08 am
// Author : ±èÁØ¸ð
BuyItemList* MemberList::getNowLoginBuyList() {
    return memberList[nowLoginMemberIndex]->getBuyItemList();
}